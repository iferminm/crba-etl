...
value_mapper = {
    ...
    "DIM_AGE_GROUP": {
        ...
        "NEO-NATAL": ["NEO: Neo-natal", "NEO: Neonatal"],
        "<1 YEAR": ["<1Y"],
        "<5 YEARS": ["<5Y"],
        "<6 YEARS": ["<6Y"],
        "<8 YEARS": ["<8Y"],
    ...
    "DIM_AREA_TYPE": {
        "TOTAL": ["TOTL", "_T: Total", "ALLAREA", "TOTL"],
        "RURAL": ["RUR", "R: Rural", "RURAL", "RUR"],
        "URBAN": ["URB", "U: Urban", "URBAN", "URB"],
        "_T": [""],
        "CITY": ["CITY"],
        "TOWN": ["TOWN"]
    },
    ...
    "DIM_OCU_TYPE": {
        ...
        "Armed forces (isco-88)": ["isco88-0", "OCU_ISCO88_0"],
        "Legislators, senior officials and managers (isco-88)": ["isco88-1", "OCU_ISCO88_1"],
        "Professionals (isco-88)": ["isco88-2", "OCU_ISCO88_2"],
        "Technicians and associate professionals (isco-88)": ["isco88-3", "OCU_ISCO88_3"],
        "Clerks (isco-88)": ["isco88-4", "OCU_ISCO88_4"],
        "Service workers and shop and market sales workers (isco-88)": ["isco88-5", "OCU_ISCO88_5"],
        "Skilled agricultural and fishery workers (isco-88)": ["isco88-6", "OCU_ISCO88_6"],
        "Craft and related trades workers (isco-88)": ["isco88-7", "OCU_ISCO88_7"],
        "Plant and machine operators and assemblers (isco-88)": ["isco88-8", "OCU_ISCO88_8"],
        "Elementary occupations (isco-88)": ["isco88-9", "OCU_ISCO88_9"],
